...
class QuestionViewController: UIViewController {
    ...
    var questions: [Question] = [Question(text: "Which food do you like the most?", type: .single, answers: [Answer(text: "Steak", type: .dog),
    ...
    // Keep track the question displayed
    var questionIndex = 0
    
    // Initial an empty collection that can
